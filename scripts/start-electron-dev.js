...
async function startElectronDev() {
  ...
  // En Windows, npm es un archivo .cmd, necesitamos usar cmd.exe con CREATE_NO_WINDOW
  ...
  // En Windows, npx es un archivo .cmd, necesitamos usar cmd.exe con CREATE_NO_WINDOW
